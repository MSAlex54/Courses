package Java1.Lesson_7.HomeWork.Server;
...
public class MainServer {
    ...
    public void privateMsg(ClientHandler client ,String nick, String msg) {
        client.sendMsg(msg);
        for (ClientHandler o: clients) {
    ...
    public Boolean isAlreadyOnline (String nick) {
        Boolean alredyOnline = false;
        for (ClientHandler o: clients) {
            if (o.getNick().equals(nick))
                alredyOnline=true;
                break;
